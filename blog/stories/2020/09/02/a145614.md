...
We think if it hasn't been proven that our government is an outpost of Putin's government then we can pretend everything is as it always has been.  

And when it is proven (as it has been many times) we forget that and keep snapping back to believing it hasn't yet been proven. If you watch the news with a scientist's notebook, you'd see that happens often, sometimes within one installment of The Situation Room or even the esteemed Rachel Maddow. 
